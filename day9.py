...
class Program:
    ...
    def read(self, mode: ParameterMode, pointer: int, literal: bool):
    ...
    def run_program(self):
        ...
        while True:
            ...
            if opcode == Op.ADDITION:
                parameter_1: int = self.read(ParameterMode(int(op//100) % 10), self.program_counter+1, False)
                parameter_2: int = self.read(ParameterMode(int(op//1000) % 10), self.program_counter+2, False)
                parameter_3: int = self.read(ParameterMode(int(op//10000) % 10), self.program_counter+3, True)

                value = parameter_1 + parameter_2
                self.memory[parameter_3] = value
                ...
                parameter_1: int = self.read(ParameterMode(int(op//100) % 10), self.program_counter+1, True)
                inp = self.inputs.pop(0)
                self.memory[parameter_1] = inp
